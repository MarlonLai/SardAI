/*
  ...
  1. Database Functions
    - Safely recreate functions without breaking dependencies
  ...
  2. Security
    ...
    - Functions will be further restricted by RLS policies
*/
...
-- Recreate update_updated_at_column function (don't drop it since triggers depend on it)
-- This will replace the existing function if it exists
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'pending_reports', rc.pending_reports,
    'recent_errors', ec.recent_errors,
    'updated_at', NOW()
  ) INTO stats_result
  FROM user_counts uc, premium_counts pc, report_counts rc, error_counts ec;
