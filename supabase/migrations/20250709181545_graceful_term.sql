/*
  # Sistema Chat Completo con Gestione Piani Utente

  1. Nuove Tabelle
    - `user_subscriptions` - Gestione abbonamenti e periodi di prova
    - `chat_sessions` - Sessioni di chat per organizzare conversazioni
    - `chat_messages` - Messaggi delle conversazioni
    
  2. Funzioni
    - `get_user_plan_status` - Determina stato piano utente (trial, free, premium)
